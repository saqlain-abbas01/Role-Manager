    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-display font-bold text-foreground">My Tasks</h1>
          <p className="text-muted-foreground mt-1">Keep track of your assigned work.</p>
        </header>
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {task.status === 'resolved' && (
                      <span className="text-sm text-muted-foreground italic px-3">Pending Verification</span>
                    )}
